...
*/
    ...
    public StagBase() {
        ...
        super("StagBase", SmartDashboard.getNumber("basePP value", 1), SmartDashboard.getNumber("baseII value", 1), SmartDashboard.getNumber("baseDD value", 1));
        setAbsoluteTolerance(SmartDashboard.getNumber("tolerance base", 0.02));
        getPIDController().setContinuous(false);
        LiveWindow.addActuator("StagBase", "PIDSubsystem Controller", getPIDController());
        SmartDashboard.putString("print me", "init current encoder position " + leftFront.getEncPosition());
