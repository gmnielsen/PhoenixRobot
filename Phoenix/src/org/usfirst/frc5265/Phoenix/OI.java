...
public class OI {
    ...
    public OI() {
        ...
        /* commented out by GN
        btnRampart = new JoystickButton(steeringWheel, 20);
        btnRampart.whileHeld(new Rampart());
        btnChevDefree = new JoystickButton(steeringWheel, 21);
        btnChevDefree.whenPressed(new ChevDefree());
        btnPortcul = new JoystickButton(steeringWheel, 22);
        btnPortcul.whenPressed(new Portcul());
        btnChange = new JoystickButton(steeringWheel, 23);
        btnChange.whenPressed(new posChange());
        btnBall = new JoystickButton(steeringWheel, 24);
        btnBall.whenPressed(new posBall());
        btnLow = new JoystickButton(steeringWheel, 25);
